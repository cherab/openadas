...
def populate(download=True, repository_path=None, adas_path=None):
    ...
    rates = {
        ...
        'adf11ccd': (
            (hydrogen, 'adf11/ccd96/ccd96_h.dat'),
            (helium, 'adf11/ccd96/ccd96_he.dat'),
            (lithium, 'adf11/ccd89/ccd89_li.dat'),
            (beryllium, 'adf11/ccd89/ccd89_be.dat'),
            (boron, 'adf11/ccd89/ccd89_b.dat'),
            (carbon, 'adf11/ccd96/ccd96_c.dat'),
            (nitrogen, 'adf11/ccd89/ccd89_n.dat'),
            (oxygen, 'adf11/ccd89/ccd89_o.dat'),
            (neon, 'adf11/ccd89/ccd89_ne.dat'),
            (argon, 'adf11/ccd89/ccd89_ar.dat'),
            (krypton, 'adf11/ccd89/ccd89_kr.dat'),
            (xenon, 'adf11/ccd89/ccd89_xe.dat'),
        ),
        'adf11plt': (
